...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--protocol', type=str, default="dp", help="federated learning protocal")
    ...
    # other arguments
    parser.add_argument('--Threshold', type=float, default=0.3, help="Threshold of secagg")
